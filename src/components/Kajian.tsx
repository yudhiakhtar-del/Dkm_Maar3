                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-100 dark:border-slate-800/80 flex space-x-2">
                    <button
                      ...
                      className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs py-2.5 rounded-lg transition-colors flex items-center justify-center space-x-1"
                    >
